...
#define SERIAL_IR_GPIO_TX                21
#define SERIAL_IR_GPIO_RX                22
...
/* Definição - timeout */
#define TIMEOUT_SERIAL_INFRARED           1000 //ms

/* Definição - endereço */
#define ENDERECO_ETIQUETA_HIGH            0x00
#define ENDERECO_ETIQUETA_LOW             0x01

/* Definições - tipos de etiqueta aceitas */
#define TIPO_ETIQUETA_UNIDADE_OU_KG          'U'
#define TIPO_ETIQUETA_OFERTA                 'O'
